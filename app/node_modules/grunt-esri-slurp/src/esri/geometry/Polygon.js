//>>built
define(["dojo/_base/declare", "dojo/_base/array", "dojo/_base/lang", "dojo/has", "../kernel", "../lang", "../SpatialReference", "./Geometry", "./Point", "./Extent", "./mathUtils"], function(A, n, k, E, F, B, C, D, m, v, y) {
    var z = {
            type: "polygon",
            rings: null
        },
        l = A(D, {
            ...
            addRing: function(a) {
                ...
                k.isArray(a[0]) ? n.forEach(a, this._addPointArr, this) : n.forEach(a, this._addPoint, this);
                return this
            },
            ...
            getPoint: function(a, b) {
                if (this._validateInputs(a, b)) return new m(this.rings[a][b], this.spatialReference)
            },
            ...
            removeRing: function(a) {
                if (this._validateInputs(a, null)) {
                    ...
                    for (b = 0; b < c; b++) a[b] = new m(a[b], d);
                    return a
                }
            },
            removePoint: function(a, b) {
                if (this._validateInputs(a, b)) return this._extent = this._centroid = null, new m(this.rings[a].splice(b, 1)[0], this.spatialReference)
            },
            getExtent: function() {
                var a;
            ...
            contains: function(a) {
                ...
                var l = a.x;
                a = a.y;
                c && (e && !c.equals(e) && c._canProject(e)) && (a = c.isWebMercator() ? m.lngLatToXY(l, a) : m.xyToLngLat(l, a, !0), l = a[0], a = a[1]);
                for (q = 0; q < k; q++) {
                    c = b[q];
                    h = c.length;
                    for (p = f = 0; p < h; p++)
            ...
            getCentroid: function() {
                ...
                var a, b, c, d, e = [],
                    g, h;
                n.forEach(this.rings, function(d) {
                    a = b = c = 0;
                    n.forEach(d, function(e, l) {
                ...
                d = 6 * e[0][2];
                return this._centroid = new m(e[0][0] / d, e[0][1] / d, this.spatialReference)
            },
            isClockwise: function(a) {
                var b = 0,
                    c, d = a.length,
                    e = k.isArray(a[0]) ? function(a, b) {
                        return a[0] *
                            b[1] - b[0] * a[1]
                    } : function(a, b) {
