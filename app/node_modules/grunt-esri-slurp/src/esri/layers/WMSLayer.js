//>>built
define(["require", "dojo/_base/kernel", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "../kernel", "../request", "../urlUtils", "../SpatialReference", "../geometry/Extent", "./DynamicMapServiceLayer", "./WMSLayerInfo", "dojo/query"], function(s, g, t, n, f, x, y, u, l, m, h, v, w) {
    return t([v], {
        ...
        getImageUrl: function(a, b, c, d) {
            if (!this.visibleLayers || 0 === this.visibleLayers.length) d(this._blankImageURL);
                ...
                if (f.some(this._WEB_MERCATOR, function(a) {
                    ...
                    var k = f.filter(this.spatialReferences, function(a) {
                        return f.some(this._WEB_MERCATOR, function(b) {
                            return b == a
                        })
                    }, this);
                    0 === k.length && (k = f.filter(this.spatialReferences, function(a) {
                        return f.some(this._WORLD_MERCATOR, function(b) {
                            return b == a
                        })
                    }, this));
                    e = 0 < k.length ? k[0] : this._WEB_MERCATOR[0]
                }
                ...
                "1.3.0" ==
                this.version && this._useLatLong(b) ? a.BBOX = q + "," + k + "," + r + "," + p : a.BBOX = k + "," + q + "," + p + "," + r;
                b = this.getMapURL;
                var g;
                b += -1 == b.indexOf("?") ? "?" : "";
                for (g in a) a.hasOwnProperty(g) && (b += "?" == b.substring(b.length - 1, b.length) ? "" : "\x26", b += g + "\x3d" + a[g]);
                d(l.addProxy(b))
            }
        },
        _initLayer: function(a, b) {
            this.spatialReference = new m(this.extent.spatialReference);
            this.initialExtent = new h(this.extent);
            this.fullExtent = new h(this.extent);
            ...
            if (a) {
                ...
                if (b = this._getTag("Layer", a)) {
                    ...
                    f.forEach(b.childNodes, function(a) {
                        "Layer" == a.nodeName && (0 ===
                            d ? e = a : (1 === d && c.name && (c.name = "", c.subLayers = [], c.subLayers.push(this._getLayerInfo(e))), c.subLayers.push(this._getLayerInfo(a))), d++)
                    }, this);
                    if (c) {
                        this.layerInfos = c.subLayers;
                        if (!this.layerInfos || 0 === this.layerInfos.length) this.layerInfos = [c];
                        this.extent = c.extent;
                        this.extent || (c.extent = new h(this.layerInfos[0].extent.toJson()), this.extent = c.extent);
                        this.allExtents = c.allExtents;
                        if (!this.allExtents || !this.allExtents.length) c.allExtents = [], f.forEach(this.layerInfos[0].allExtents, function(a, b) {
                            a && (c.allExtents[b] =
                                new h(a.toJson()))
                        }), this.allExtents = c.allExtents;
                    ...
                    if ((b = g.query("DCPType", this._getTag("GetMap", a))) && 0 < b.length)
                        if ((b = g.query("HTTP", b[0])) && 0 < b.length)
                            if ((b = g.query("Get", b[0])) && 0 < b.length)
                                if (b = this._getAttributeValue("OnlineResource", "xlink:href", b[0], null)) b.indexOf("\x26") == b.length - 1 && (b =
                                    b.substring(0, b.length - 1)), this.getMapURL = b;
                    this.getMapFormats = [];
                    ...
                    }, this) || (this.imageFormat =
                        this.getMapFormats[0]);
                    this._initLayer()
        ...
        _getLayerInfo: function(a) {
            ...
            !c && !d && (e = new h(-180, -90, 180, 90, new m({
                    wkid: 4326
                })),
                b.allExtents[0] = e);
            ...
            f.forEach(a.childNodes, function(a) {
                if ("Name" == a.nodeName) b.name = (a.text ? a.text : a.textContent) || "";
                    ...
                    c && 0 === c.indexOf("EPSG:") ? (c = parseInt(c.substring(5), 10), 0 !== c && !isNaN(c) && (a = "1.3.0" ==
                    ...
                    a = -1 < a.indexOf(":") ? parseInt(a.split(":")[1], 10) : parseInt(a,
                        10);
        ...
        _stripParameters: function(a, b) {
            var c = l.urlToObject(a),
                d, e = [];
            for (d in c.query) c.query.hasOwnProperty(d) && -1 === f.indexOf(b, d.toLowerCase()) && e.push(d + "\x3d" + c.query[d]);
