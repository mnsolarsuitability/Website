//>>built
define(["dojo/_base/declare", "dojo/_base/connect", "dojo/_base/lang", "dojo/_base/array", "dojo/dom-attr", "dojo/dom-construct", "dojo/dom-style", "dojox/gfx", "dojox/gfx/matrix", "./layer", "../kernel", "../lang", "../sniff", "../Color", "../domUtils", "../symbols/MarkerSymbol", "../symbols/SimpleMarkerSymbol", "../geometry/Point", "../geometry/ScreenPoint", "../geometry/Extent", "../geometry/mathUtils", "../geometry/screenUtils", "../PluginTarget"], function(x, q, y, l, I, N, G, A, u, T, U, P, H, V, C, W, w, Q, J, B, R, K, X) {
    var L, M = -1 !== A.renderer.toLowerCase().indexOf("svg"),
        D = -1 !== A.renderer.toLowerCase().indexOf("canvas"),
        t = 9 > H("ie"),
        S = H("esri-touch"),
        Y = x(null, {
            ...
            _setMap: function(a, b) {
                ...
                D ? (c = N.create("div", {
                    ...
                    }, e.push(q.connect(c, "onmousedown", this, this._canvasDownHandler)), e.push(q.connect(c, "onmouseup", this, this._canvasUpHandler)), e.push(q.connect(c, "onclick", this, this._canvasClickHandler)),
    ...
    L = x(T, {
                ...
                if (a.visible && c && (e = this._intersects(this._map, c, a.geometry._originOnly)) && (d = g ? this._getSymbol(a) : this._defaultMarker)) {
                    if (!a._offsets || a._offsets.join(",") !== e.join(",") ? a._offsets = e : k = !0, !h || b || !k) {
                        ...
                        if ("point" === m) this._isInvalidShape(d, h) && this._removeShape(a), a._shape = this._drawPoint(this._div, a.geometry, d, a.getDojoShape(), e, n, a), g && this._symbolizePoint(a.getDojoShape(), d, n, a);
                            ...
                            var v, m = d,
                                E, F;
                            g && (m = (v = d.isInstanceOf(W) ? d : null) ? l : d);
        ...
        _applyOpacity: function(a, b, c) {
            b = b.getOpacity(c);
            null != b && (a = new V(a), a.a = b);
            return a
        },
        _symbolizeShape: function(a, b, c, e) {
            ...
            if (c && (c.colorInfo || c.opacityInfo) && "picturefillsymbol" !== b) - 1 !== b.indexOf("linesymbol") ? (f = d && d.color, c.colorInfo && (f = c.getColor(e)), f && c.opacityInfo && (f = this._applyOpacity(f, c, e))) : g && g.toCss && (h = g, c.colorInfo && (h = c.getColor(e)),
                h && c.opacityInfo && (h = this._applyOpacity(h, c, e)));
        ...
        _smsToPath: function() {
            return t ? function(a, b, c, e, d, g, f, h, k) {
                ...
                switch (b) {
                    ...
                    case a.STYLE_TARGET:
                        return ["M",
                            d + "," + f, g + "," + f, g + "," + h, d + "," + h, d + "," + f, "M", d - k + "," + e, d + "," + e, "M", c + "," + (f - k), c + "," + f, "M", g + k + "," + e, g + "," + e, "M", c + "," + (h + k), c + "," + h
                        ]
                }
            }
        }(),
        ...
        _drawPoint: function(a, b, c, e, d, g, f) {
            ...
            if ("simplemarkersymbol" === h) switch (n = c.style, h = Math.round,
                g = v ? g : c.size, n) {
                case w.STYLE_SQUARE:
                case w.STYLE_CROSS:
                case w.STYLE_X:
                ...
                case w.STYLE_TARGET:
                    p = c._targetWidth / 2;
                    v = c._targetHeight / 2;
                    n = this._drawPath(a, e, this._smsToPath(w, n, k, m, h(k - p), h(k + p), h(m - v), h(m + v), c._spikeSize));
                    break;
                case w.STYLE_PATH:
                    ...
                    b.push(u.translate(-(c.x +
                        c.width / 2) + k, -(c.y + c.height / 2) + m));
                    break;
                default:
                ...
                height: p,
                src: c.url
            }), e.add(n), null != c.font && (m += 0.2 * c.getHeight(), a = a.createText({
                type: "text",
                text: c.text,
                x: k,
                y: m,
                ...
                rotated: c.rotated,
                kerning: c.kerning
            }), a.setFont(c.font), a.setFill(c.color), e.add(a)), n = e) : "picturemarkersymbol" === h ? (n = v ? g : c.width, p =
                v ? g : c.height, n = this._drawImage(a, e, {
                    x: k - n / 2,
                    y: m - p / 2,
                    width: n,
                    height: p,
        ...
        _symbolizePoint: function(a, b, c, e) {
            ...
            if (!("shieldlabelsymbol" === d || "picturemarkersymbol" === d)) {
                var g;
                "textsymbol" === d ? a.setFont(b.font).setFill(b.getFill()) : (g = b.getStroke(), b = b.getFill(), c && (c.colorInfo && (b = c.getColor(e)), b && c.opacityInfo && (b = this._applyOpacity(b, c, e))), "simplemarkersymbol" === d && a.setFill(b).setStroke(g))
            }
        },
            ...
            if (!d(c.tl, g, f) || !d(e, g, f)) {
                ...
                l.forEach(a.segments, function(a) {
                    ...
                    for (e = 0; e < c; e += 2) {
                        ...
                        } else f ? e ? b.push(g) : b.push(d, g) : (l = n(d, h), f = n(g, h), -1 === l || (-1 === f || l === f) || (d = p([d, g], k, !0), 0 < d.length && (d[l] || (l = d[l[0]] ? l[0] : l[1]), d[f] || (f = d[f[0]] ? f[0] : f[1]), g = d[l], d = d[f], g && b.push(g), d && (b.push(d), q.push(b), b = []))))
                    }
                    q.push(b)
                });
            ...
            if (!d(c.tl, f, h) || !d(e, f, h)) t && this._createSegments(a), c = l.map(a.segments, function(a) {
                ...
                for (e = 0; e < b; e += 2) {
                    ...
                    if (s ^ r) {
                        ...
                        var s =
                            q(f, k),
                            z = q(h, k); - 1 === s || (-1 === z || s === z) || (r = n([f, h], m, !0), 0 < r.length ? (r[s] || (s = r[s[0]] ? s[0] : s[1]), r[z] || (z = r[z[0]] ? z[0] : z[1]), f = r[s], h = r[z], f && (f.outIn = !0, d.push(f), a.push(["OUTIN", d.length - 1, s])), h && (h.inOut = !0, d.push(h), a.push(["INOUT", d.length - 1, z]))) : y.isArray(s) && y.isArray(z) && (r = s.concat(z), r.sort(), "0123" === r.join("") && (r = [], 3 === s[0] + s[1] ? r.push([g, -g], [-g, g]) : r.push([-g, -g], [g, g]), s = v(r[0], [f, h]), f = v(r[1], [f, h]), d.push(s < f ? r[0] : r[1]))))
                    }
                }
                var t = k[0],
                    u = k[1],
                ...
                for (c = 0; c < d.length - 1; c++)
                    if (b = d[c], (e = d[c + 1]) && !(b[0] !== e[0] || b[1] !== e[1])) e.outIn ? b.outIn = !0 : e.inOut && (b.inOut = !0), d.splice(c + 1, 1);
                b = Math.abs;
                a = [];
                for (c = 0; c < d.length - 1; c++) {
                    h = d[c];
    ...
    x = x([L, X], {
        ...
        _onMouseDownHandler: function(a) {
            ...
            this._processEvent(a) && (q.disconnect(this._onmousemove_connect), q.disconnect(this._onmousedrag_connect), this._onmousedrag_connect = q.connect(this._div.getEventSource(), "onmousemove", this, "_onMouseDragHandler"), this._downGr = a.graphic, this._downPt = a.screenPoint.x + "," + a.screenPoint.y, this.onMouseDown(a))
        },
        _onMouseUpHandler: function(a) {
            this._upGr = this._upPt = null;
            this._processEvent(a) && (q.disconnect(this._onmousedrag_connect), q.disconnect(this._onmousemove_connect),
                this._onmousemove_connect = q.connect(this._div.getEventSource(), "onmousemove", this, "_onMouseMoveHandler"), this._upGr = a.graphic, this._upPt = a.screenPoint.x + "," + a.screenPoint.y, this.onMouseUp(a))
        },
        _onClickHandler: function(a) {
            if (this._processEvent(a)) {
                var b = this._downGr,
                    c = this._upGr;
                b && (c && b === c && this._downPt === this._upPt) && (t && (U._ieGraphic = a.graphic), this.onClick(a))
            }
        },
        ...
        enableMouseEvents: function() {
            if (!this._mouseEvents) {
                ...
                D || (this._onmouseover_connect = a(b, "onmouseover", this, "_onMouseOverHandler"), this._onmousemove_connect = a(b, "onmousemove", this, "_onMouseMoveHandler"), this._onmouseout_connect = a(b, "onmouseout", this, "_onMouseOutHandler"), this._onmousedown_connect = a(b, "onmousedown", this, "_onMouseDownHandler"),
