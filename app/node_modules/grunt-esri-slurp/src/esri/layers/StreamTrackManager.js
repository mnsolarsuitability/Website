//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "../kernel", "../graphic", "../geometry/Polyline", "./GraphicsLayer", "./TrackManager"], function(p, t, l, u, v, q, r, w, s) {
    return p([s], {
        ...
        addFeatures: function(b, g) {
            function f(c, a) {
                ...
                h[c] || (h[c] = []);
                b = h[c];
                0 < e && (a.length > e && a.splice(0, a.length - e), k = a.length + b.length, k > e && (d = b.splice(0,
                    k - e)));
                k = a.length;
        ...
        drawTracks: function(b) {
            function g(c) {
                ...
                b = {};
                b[e] = c;
                1 < d.length && (m ? (c = m.geometry, c.removePath(0), c.addPath(d), m.setGeometry(c)) :
                    (m = new q(new r({
                        paths: [d],
                        spatialReference: n
