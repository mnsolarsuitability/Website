//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "../kernel", "../SpatialReference", "../tasks/query", "../tasks/QueryTask", "../geometry/jsonUtils", "./RenderMode"], function(m, k, l, t, u, n, p, q, r, s) {
    return m([s], {
        ...
        constructor: function(a, b) {
            ...
            this._drawFeatures = k.hitch(this,
                this._drawFeatures);
            this._queryErrorHandler = k.hitch(this, this._queryErrorHandler)
        },
        startup: function() {},
        ...
        drawFeature: function(a) {
            ...
            b._joinField &&
                this._getFeature(a.attributes[c]) ? this._drawBuffer.updates.push({
                    oid: a.attributes[c],
                    updates: a
        ...
        _addFeatures: function(a) {
            ...
            g = b.objectIdField;
            if (c)
                for (d in a = c.addFeatures(a), a) a.hasOwnProperty(d) && (h.push(d), a[d].adds && (e = e.concat(a[d].adds)), a[d].deletes && (f = f.concat(a[d].deletes)));
            else e = a;
            l.forEach(e, function(a) {
                var b = a.attributes[g];
                this._addFeatureIIf(b, a);
                this._incRefCount(b)
            }, this);
            f.length && this._removeFeatures(f);
            c && c.refreshTracks(h)
        },
        _updateFeatures: function(a) {
            ...
            l.forEach(a, function(a) {
                ...
                var f;
                if (a) {
                    e.geometry && (a.geometry = e.geometry);
                    e = e.attributes || {};
                    for (f in e) e.hasOwnProperty(f) && (a.attributes[f] = e[f]);
                    a.visible = this._checkFeatureTimeIntersects(a);
                    c && a.attributes[g] ? d.push(a.attributes[g]) : b._repaint(a, null, !0)
                }
            }, this);
        ...
        _flushDrawBuffer: function() {
            ...
            var a = this._drawBuffer,
                ...
                a = a.updates.splice(0, a.updates.length),
                c = this.featureLayer;
            if (!c) return !1;
            c.onUpdateStart();
            this._addFeatures(b);
            this._updateFeatures(a);
            c._purge();
            c.onUpdateEnd();
            this._timeoutId = null
        },
        ...
        _getRequestId: function(a) {
            return ("_" + a.name + a.layerId + a._ulid).replace(/[^a-zA-Z0-9\_]+/g,
                "_")
        },
