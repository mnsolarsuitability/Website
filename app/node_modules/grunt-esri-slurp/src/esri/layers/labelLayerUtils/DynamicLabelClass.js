//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/connect", "dojo/has", "dojox/gfx/_base", "../../kernel", "../../lang", "../../SpatialReference", "../GraphicsLayer", "../LabelClass", "../../renderers/SimpleRenderer", "../../geometry/Geometry", "../../geometry/Extent", "../../geometry/Point", "../../geometry/Polyline", "../../geometry/Polygon", "../../symbols/TextSymbol", "../../symbols/ShieldLabelSymbol", "../../symbols/SimpleLineSymbol"], function(F, I, J, K, L, M, N, O, G, P, Q, R, H, S, T, E, U, V, W) {
    return F(G, {
        ...
        _process: function(e) {
            ...
            for (e = this._preparedLabels.length - 1; 0 <= e; e--) {
                var a = this._preparedLabels[e],
                    ...
                    k = [2, 2, 1, 3, 0, 2, 3, 3, 2];
                "AboveLeft" == b ? k = [1, 2, 2, 2, 0, 3, 2, 3, 3] : "AboveCenter" == b ? k = [2, 1, 2, 2, 0, 2, 3, 3, 3] : "AboveRight" == b ? k = [2, 2, 1, 3, 0, 2, 3, 3, 2] : "CenterLeft" == b ? k = [2, 2, 3, 1, 0, 3, 2, 2, 3] : "CenterCenter" == b ? k = [0, 0, 0, 0, 1, 0, 0, 0, 0] :
                    "CenterRight" == b ? k = [3, 2, 2, 3, 0, 1, 3, 2, 2] : "BelowLeft" == b ? k = [2, 3, 3, 2, 0, 3, 1, 2, 2] : "BelowCenter" == b ? k = [3, 3, 3, 2, 0, 2, 2, 1, 2] : "BelowRight" == b && (k = [3, 3, 2, 3, 0, 2, 2, 2, 1]);
        ...
        _generatePolygonPositions: function(e, d, a, f, g, h, c) {
            var b;
            if ("ManyLabels" == d)
                for (d = 0; d < a.rings.length; d++) b = a.rings[d], E.prototype.isClockwise(b) && (b = this._findCentroid(b, this._xmin, this._ymin, this._xmax, this._ymax), this._findPlace(e, f, b[0], b[1], g, h, c));
            else {
        ...
        _fillBuffer: function(e, d, a) {
            for (var f = e.length - 1, g = e[0][1] >= e[f][1] ? 1 : -1, h = 0; h <= f; h++) {
                ...
                var k = e[c][0],
                    ...
                    b = e[b][1],
                    p = b >= c ? 1 : -1;
                if (c <= a[1] && a[1] <= b || b <= a[1] && a[1] <= c) a[1] != c && a[1] != b ? (d.push((a[1] - c) * (m - k) / (b - c) + k), g = p) : a[1] == c && a[1] != b ?
                    (g != p && d.push(k), g = p) : a[1] != c && a[1] == b ? (d.push(m), g = p) : a[1] == c && a[1] == b && (1 == g && d.push(k), d.push(m), g = p)
            }
        },
        ...
        _findPlace: function(e, d, a, f, g, h, c) {
            ...
            for (var b = 0; b < this._placedLabels.length; b++) {
                ...
                if (0 === g && 0 === k) {
                    ...
                    var s = new H(-h * this._scale, -c * this._scale, h * this._scale, c * this._scale, null),
                        r = 0,
                        q = 1;
