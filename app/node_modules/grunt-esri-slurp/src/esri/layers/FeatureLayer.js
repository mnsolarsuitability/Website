    ...
    var ta = X.defaults,
        t = S(ha, {
            ...
            _initFeatureLayer: function(a, c) {
                ...
                c = c || {};
                this.showLabels =
                    null != c.showLabels ? c.showLabels : !0;
                this._outFields = c.outFields;
                this._defnExpr = c.definitionExpression;
                ...
                this.generalizeForScale = null != c.generalizeForScale ?
                    c.generalizeForScale : this.generalizeForScale;
                this.queryPagination = null != c.queryPagination ? c.queryPagination : this.url ? this.reHostedFS.test(this.url) : !1;
                ...
                this._selectHandler =
                    q.hitch(this, this._selectHandler);
                this._editable = !1;
            ...
            _initLayer: function(a, c) {
                if (a || c) {
                    ...
                    this._collection && (this._isStream ||
                        (this.currentMode = t.MODE_SNAPSHOT, this._mode = new L(this)), this._isSnapshot = !0, this._featureSet = a.featureSet, this._nextId = a.nextObjectId, a = a.layerDefinition);
                    ...
                    } else this._collection || (this._editable =
                        this._fserver);
                    ...
                    else if (this.currentMode !== t.MODE_SNAPSHOT && ("esriGeometryPolyline" === this.geometryType || "esriGeometryPolygon" === this.geometryType || this.hasXYFootprint())) this._autoGeneralize = r.isDefined(this._optAutoGen) ? this._optAutoGen : this.currentMode === t.MODE_ONDEMAND,
                        delete this._optAutoGen;
                    var b = a.effectiveMinScale || a.minScale,
                        d = a.effectiveMaxScale || a.maxScale;
                    !this._hasMin && b && this.setMinScale(b);
                    ...
                    this.fullExtent.spatialReference && (this.spatialReference =
                        new I(this.fullExtent.spatialReference.toJson()));
                    ...
                    m = this.templates = [];
                    if (n)
                        for (b = 0; b < n.length; b++) h = new la(n[b]), g && l.push(h), m.push(h);
                    for (b = 0; b < l.length; b++)
                        if (g = q.getObject("prototype.attributes", !1, l[b])) e && delete g[e], f && delete g[f];
                    if (b = a.timeInfo) this.timeInfo = new ja(b), this._startTimeField = b.startTimeField, this._endTimeField = b.endTimeField,
                        this._startTimeField && this._endTimeField && (this._twoTimeFields = !0), this._trackIdField ? b.trackIdField = this._trackIdField : this._trackIdField = b.trackIdField;
                    ...
                    if (!this.renderer)
                        if (b && b.renderer) {
                            if (p = b.renderer, this.setRenderer(ba.fromJson(p)), "classBreaks" === p.type &&
                        ...
                        this.types, 0 < n.length ? (p = new aa(this.defaultSymbol, this.typeIdField), k.forEach(n, function(a) {
                    ...
                    this._collection ? (s = this._featureSet, this._featureSet = null, this._mode._drawFeatures(new K(s)), this._fcAdded = !0, v.call(this)) : this._forceIdentity(this._limitPromise ? function() {
                        var a = this;
            ...
            onRendererChange: function() {
                ...
                this.loaded && (this._fixRendererFields(),
                    this._checkFields(this._rendererFields), this._collection && (this._typesDirty = !0))
            },
            redraw: function() {
                this.inherited(arguments);
            ...
            selectFeatures: function(a, c, b, d) {
                ...
                e && (a.outSpatialReference =
                    new I(e.spatialReference.toJson()));
            ...
            queryIds: function(a, c, b) {
                return this._query("executeForIds",
                    "onQueryIdsComplete", a, c, b)
            },
            queryCount: function(a, c, b) {
                return this._query("executeForCount", "onQueryCountComplete", a, c, b)
            },
            ...
            onResume: function(a) {
                ...
                if (a.firstOccurrence) {
                    ...
                    this._checkFields();
                    this.clearSelection();
                    if (this.timeInfo && !this._trackManager && (this._trackIdField || d && (d.latestObservationRenderer || d.trackRenderer))) this._trackManager = new qa(this), this._trackManager.initialize(b);
                    d && ("colors" in d && "blurRadius" in d && "maxPixelIntensity" in d) && "esriGeometryPoint" == this.geometryType && (this._heatmapManager = new ra(this), this._heatmapManager.initialize(b));
            ...
            _toggleTime: function(a) {
                var c = this._map;
                a && this.timeInfo && this.useMapTime && c ? (this._mapTimeExtent = c.timeExtent, this._timeConnect || (this._timeConnect = C.connect(c, "onTimeExtentChange", this, this._timeChangeHandler))) : (this._mapTimeExtent = null, C.disconnect(this._timeConnect), this._timeConnect = null)
            },
                ...
                if (!(this._isTable || !b && !this._collection))
                    if (!a.text && !(a.where && a.where !== this.getDefinitionExpression() || a.orderByFields && a.orderByFields.length || a.outStatistics || a.returnDistinctValues)) {
                        var d = this._isSnapshot,
                            ...
                            f = a.geometry;
                        if (f)
                            if (!e && a.spatialRelationship === J.SPATIAL_REL_INTERSECTS && "extent" === f.type && (d || b.extent.contains(f))) c.push(1);
                            else return;
                        if (b = a.objectIds)
                            if (d) c.push(2);
                            else {
            ...
            _getAbsMid: function(a) {
                return M.toAbsMid ? M.toAbsMid(a) : R.id.replace(/\/[^\/]*$/ig, "/") + a
            },
            _doQuery: function(a, c, b) {
                ...
                if (-1 !== k.indexOf(c, 1)) {
                    ...
                    null == p && ta.autoSpatialIndexing ? s = (this._map || this).addPlugin(this._getAbsMid("../plugins/spatialIndex")).then(q.hitch(this,
                        q.partial(this._getFromIndex, B, p)), function(a) {
                ...
                m.then(function(d) {
                    ...
                    if (-1 !== k.indexOf(c, 2)) {
                        ...
                        h = w(d, h)
                    } else h = d; - 1 !== k.indexOf(c,
                        3) && l.timeInfo && (d = a.timeExtent, h = l._filterByTime(0 < h.length ? h : l.graphics, d.startTime, d.endTime).match);
            ...
            _filterByExtent: function(a, c) {
                for (var b = [], d = 0, e = a.length; d < e; d++) {
                    var f = a[d],
                        l = f.geometry;
                    l && (this.normalization && c.length ? (c[0].intersects(l) ||
                        c[1].intersects(l)) && b.push(f) : c.intersects(l) && b.push(f))
                }
                return b
            },
            _filterByTime: function(a, c, b) {
                ...
                if (f)
                    for (n = 0; n < m; n++) k = a[n], p = k.attributes, d = p[f], d >= c && d <= b ? g.push(k) : h.push(k);
                else
            ...
            _query: function(a, c, b, d, e) {
                ...
                if ("executeRelationshipQuery" !== a) {
                    ...
                    h.returnGeometry = b.hasOwnProperty("returnGeometry") ? b.returnGeometry : !b.outStatistics;
                    ...
                    if (b = "executeForExtent" !== a && this._canDoClientSideQuery(h)) return g._pendingDfd = N(this._doQuery(h, b, "executeForIds" === a || "executeForCount" === a)), g._pendingDfd.then(function(b) {
                        switch (a) {
                            case "execute":
                                m = new K;
                                m.features = b;
                ...
                if (this._collection) return this._resolve([Error("FeatureLayer::_query - " +
                    this.invalidParams)], null, e, g, !0), g;
            ...
            _convertFeaturesToJson: function(a, c, b, d) {
                ...
                for (b = 0; b < a.length; b++) {
                    var n = a[b],
                        ...
                        p = n.attributes,
                        s = n.symbol;
                    if (r && (!d || !this.loaded || this.allowGeometryUpdates)) m.geometry =
                        r.toJson();
            ...
            _selectHandler: function(a, c, b, d, e) {
                ...
                var l = this._mode,
                    ...
                    k, m;
                if (f)
                    for (f = 0; f < d.length; f++) k =
                        d[f], m = k.attributes[h], k = l._addFeatureIIf(m, k), g.push(k), this._selectFeatureIIf(m, k, l);
                else
            ...
            _selectFeatureIIf: function(a, c, b) {
                var d = this._selectedFeatures,
                    e = d[a];
                e || (b._incRefCount(a), d[a] =
                    c, this._isTable || (this._setSelectSymbol(c), c.attr("data-selected", "")));
                return e || c
            },
            _unSelectFeatureIIf: function(a, c) {
                var b = this._selectedFeatures[a];
                b && (c._decRefCount(a), delete this._selectedFeatures[a], this._isTable || (this._setUnSelectSymbol(b), b.attr("data-selected")));
                return b
            },
            ...
            _checkFields: function(a) {
                ...
                !a && (!this._isTable && !this._fserver && !this._collection) && (k.some(this.fields, function(a) {
            ...
            _fixRendererFields: function() {
                ...
                if (a && 0 < this.fields.length) {
                    var c = [],
                        b, d, a = k.filter([a, a.observationRenderer, a.latestObservationRenderer, a.trackRenderer], r.isDefined),
                        e = [].concat(a);
                    k.forEach(a, function(a) {
                    ...
                    k.forEach(e, function(a) {
                        ...
                        if (a.colorInfo) {
                            ...
                            if ((d = a.colorInfo.normalizationField) && !q.isFunction(d)) {
                                if (b = !this._getField(d) &&
                                    this._getField(d, !0)) d = a.colorInfo.normalizationField = b.name;
                                c.push(d)
                            }
                        }
                        if (a.field && (d = a.field) && !q.isFunction(d)) {
                            if (b = !this._getField(d) && this._getField(d, !0)) d = a.field = b.name;
                            c.push(d)
                        }
                        if (a.opacityInfo) {
                            if ((d = a.opacityInfo.field) && !q.isFunction(d)) {
                                if (b = !this._getField(d) && this._getField(d, !0)) d = a.opacityInfo.field = b.name;
                                c.push(d)
                            }
                            if ((d = a.opacityInfo.normalizationField) && !q.isFunction(d)) {
                                if (b = !this._getField(d) && this._getField(d, !0)) d = a.opacityInfo.normalizationField = b.name;
                                c.push(d)
                            }
                        }
                        if (!this._orderBy &&
                            a.addBreak && !q.isFunction(a.attributeField) && (a.backgroundFillSymbol || this._hasSizeDiff(a))) this._orderBy = [a.attributeField + " DESC"]
                    }, this);
                    this._rendererFields = k.filter(c, r.isDefined)
                }
            },
            ...
            _getField: function(a, c) {
                ...
                k.some(b, function(b) {
                    var f = !1;
                    (f = c ? b && b.name.toLowerCase() === a ? !0 : !1 : b &&
                        b.name === a ? !0 : !1) && (d = b);
                    return f
                });
                return d
            ...
            _editHandler: function(a, c, b, d, e, f) {
                ...
                u && g && (u = u + "@" + g);
                if (e)
                    for (g = 0; g < e.length; g++) e[g] = new E(e[g]), s || (h = e[g], h.success && (h = h.objectId, n = c[g], (m = n._graphicsLayer) && m !== this && m.remove(n),
                        m = n.attributes || {}, m[q] = h, x && (m[x] = u), y && (m[y] = u), v && (m[v] = r), z && (m[z] = r), n.setAttributes(m), p._init && p.drawFeature(n)));
                if (l)
                ...
                if (a) {
                    ...
                    for (g = 0; g < a.length; g++)
                        if (a[g] = new E(a[g]), !s && (h = a[g], h.success && (h = h.objectId, n = p._getFeature(h)))) this._unSelectFeatureIIf(h,
                            p) && b.push(n), n._count = 0, p._removeFeatureIIf(h);
            ...
            _sendAttachment: function(a, c, b, d, e) {
                ...
                return D({
                    ...
                    b = new E(b["add" === a ? "addAttachmentResult" : "updateAttachmentResult"]);
                    b.attachmentId = b.objectId;
                    b.objectId = c;
                    f._resolve([b], e, d);
                    return b
