//>>built
define(["dojo/_base/declare", "dojo/_base/connect", "dojo/_base/lang", "dojo/dom-construct", "dojo/dom-style", "dojox/xml/parser", "dojox/gfx/matrix", "../kernel", "../config", "../sniff", "../request", "../domUtils", "./layer", "./MapImage"], function(w, g, s, n, f, x, p, k, t, r, y, u, z, A) {
    ...
    return w(z, {
        ...
        _setMap: function(a, b, c) {
            ...
            var e = this._div = n.create("div", null, b),
                ...
                p = g.connect,
                q = a.__visibleDelta;
            8 === l && delete h.opacity;
            "css-transforms" === a.navigationMode ? (h[d.transform] = k._css.translate(q.x, q.y), f.set(e, h), this._left = q.x, this._top = q.y) : (h.left = "0px", h.top = "0px", f.set(e, h), this._left = this._top = 0);
            f.set(e, h);
        ...
        onResume: function() {
            ...
            this._wakeTimer = this._wakeTimer || setTimeout(s.hitch(this, function() {
        ...
        _onExtentChangeHandler: function(a, b, c) {
            if (!this.suspended) {
                ...
                "css-transforms" === e.navigationMode && (c && d) && (f.set(d, k._css.names.transition, "none"), d._multiply = d._multiply ? p.multiply(d._matrix, d._multiply) : d._matrix);
        ...
        _onScaleHandler: function(a, b) {
            ...
            if (d) {
                ...
                d._matrix = a;
                a = d._multiply ? p.multiply(a, d._multiply) : a;
                if (d._tdx || d._tdy) a = p.multiply(a, {
                    xx: 1,
                    xy: 0,
                    yx: 0,
                    yy: 1,
        ...
        _opacityChangeHandler: function(a) {
            var b = 8 === r("ie") ? this._img : this._div;
            f.set(b, "opacity", a)
        }
    })
});