...
define({
    root: {
        ...
        routeOriginDestinationPairsTool: {
            ...
            pairPoints: "Pair points into routes by matching IDs",
            originTripId: "Route ID field in origins",
            destnTripId: "Route ID field in destinations",
        ...
        summarizeNearbyTool: {
            summarizeDefine: "Find what is nearby \x3cb\x3e${sumNearbyLayerName}\x3c/b\x3e",
        ...
        analysisMsgCodes: {
            ...
            AO_100036: "The ${analysisLayer} layer must have a point geometry type when using DrivingTime or DrivingDistance as the measurement type.",
            AO_100037: "The ${nearLayer} layer must have a point geometry type when using DrivingTime or DrivingDistance as the measurement type.",
            ...
            AO_100098: "The values in ${startLayerRouteIDField} in ${startLayer} does not have a one-to-one match with the values in ${endLayerRouteIDField} in ${endLayer}.",
