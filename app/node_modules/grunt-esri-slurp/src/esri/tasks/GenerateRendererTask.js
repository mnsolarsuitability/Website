    ...
    return t(z, {
        ...
        constructor: function(a, d) {
            l.isObject(a) && ("esri.layers.FeatureLayer" ===
                a.declaredClass || "esri.layers.CSVLayer" === a.declaredClass) ? a.url && l.isString(a.url) && "esri.layers.CSVLayer" !== a.declaredClass ? (this.url = a.url, this._url = x.urlToObject(this.url), this._url.path += "/generateRenderer") : this._features = a.graphics : (this.url = a, this._url.path += "/generateRenderer");
        ...
        _handler: function(a, d, h, e, f) {
            try {
                ...
                a.declaredClass || "esri.renderer.UniqueValueRenderer" === a.declaredClass ? c = a : (c = y.fromJson(a), "classBreaks" === a.type && c.setMaxInclusive(!0));
                if (this.checkValueRange) {
                    var k = new A(this.url),
                        b = new B,
                        g = new r;
                    g.statisticType = "min";
                    ...
                    k.execute(b).then(l.hitch(this, function(a) {
                        ...
                        for (var b in a)
                            if (0 === b.toLowerCase().indexOf("min")) var d = a[b];
                            else var e = a[b];
                        c = this._processRenderer(c,
                            this._prefix, this._unitLabel, this._formatLabel, this._precision, d, e);
            ...
            if (this._features = a.features || this._features) {
                ...
                s(["./generateRenderer"], function(b) {
                    ...
                    "esri.tasks.ClassBreaksDefinition" === a.classificationDefinition.declaredClass ? g = b.createClassBreaksRenderer({
                        ...
                        }) : "esri.tasks.UniqueValueDefinition" === a.classificationDefinition.declaredClass &&
                        (g = b.createUniqueValueRenderer({
                            features: k,
                            definition: a.classificationDefinition
                        }));
