//>>built
define(["../../declare", "dojo/_base/array", "dojo/dom-construct", "./taskHelper", "../FeatureSet", "./EnrichParameters", "./ReportParameters", "../../IdentityManager", "../../geometry/Point", "../../geometry/Polygon", "../../geometry/Polyline", "dojo/i18n!../../nls/jsapi"], function(r, s, g, d, t, l, m, u, v, w, x, h) {
    function n(a) {
        this.name = "UserError";
        this.message = a || ""
    }
