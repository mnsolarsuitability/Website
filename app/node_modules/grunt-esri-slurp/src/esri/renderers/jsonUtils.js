//>>built
define(["dojo/_base/lang", "dojo/has", "../kernel", "../Color", "./SimpleRenderer", "./UniqueValueRenderer", "./ClassBreaksRenderer", "./TimeClassBreaksAger", "./TimeRampAger", "./TemporalRenderer"], function(q, r, s, g, k, l, m, e, n, p) {
    return {
        fromJson: function(a) {
            var b;
            switch (a.type || "") {
        ...
        _timeRampFromJson: function(a) {
            var b, c, d;
            a.colorRange && 1 < a.colorRange.length && (b = [g.toDojoColor(a.colorRange[0]), g.toDojoColor(a.colorRange[1])]);
        ...
        _timeClassBreaksFromJson: function(a) {
            ...
            for (f = 0; f < b.length; f += 1) a = b[f], d = {
                minAge: 0,
                maxAge: a.oldestAge || Infinity
            }, a.color && (d.color = g.toDojoColor(a.color)), a.alpha && (d.alpha = a.alpha / 255), d.size = a.size, h[f] = d;
            return new e(h, c)
        }
    }
});