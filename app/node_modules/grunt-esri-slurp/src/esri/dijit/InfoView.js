//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/kernel", "dojo/has", "dojo/query", "dojo/dom", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-geometry", "../kernel", "./_TouchBase"], function(m, s, n, d, p, t, u, q, k, e, l, v, r) {
    return m(null, {
        ...
        constructor: function(a, c) {
            ...
            for (b = 0; b < this._items.length; b++) {
                var f, h = 0;
                this._items[b].section && (h = this._items[b].section);
                switch (this._items[b].type) {
                    case "div":
                        f = e.create("div", {
                            "class": "esriMobileInfoViewItem",
                            style: this._items[b].style
                        }, this._slideDiv.childNodes[h]), f = e.create("div", {
                            innerHTML: this._items[b].text
                        }, f)
                }
                this._items[b].className && k.add(f, this._items[b].className);
                f._index = b;
        ...
        destroy: function() {
            n.forEach(this.events, d.disconnect);
            this._touchBase = null;
            p.query("img", this.container).forEach(function(a) {
                a._index = null;
                a._item = null;
                e.destroy(a)
            });
        ...
        _doMomentum: function() {
            var a, c;
            a = l.getContentBox(this.container);
            var b = 0 > this._velocity ? 0.0010 : -0.0010;
            c = -(this._velocity * this._velocity) / (2 * b);
            var e = -this._velocity / b,
                b = 3 * 0.6 - 0,
                f = 1 - b,
                g = 0,
                d = 0;
            if (a.h > this._slideDiv.scrollHeight) this.contentOffsetY = 0, d = 300;
            else if (0 < this.contentOffsetY + c) {
                a = 0;
                for (c = Math.floor(e / 20); a < c; a++)
            ...
            } else d = e, this.contentOffsetY += c;
            this._slideDiv.style.webkitTransition = "-webkit-transform " + d + "ms cubic-bezier(0, 0.3, 0.6, 1)";
            this._animateTo(this.contentOffsetY)
        },
        _snapToBounds: function() {
            var a = l.getContentBox(this.container);
        ...
        _stopMomentum: function() {
            if (this._isDecelerating()) {
                var a =
                    document.defaultView.getComputedStyle(this._slideDiv, null),
