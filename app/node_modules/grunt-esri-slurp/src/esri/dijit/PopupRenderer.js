//>>built
define(["require", "dojo/_base/declare", "dojo/_base/connect", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/kernel", "dojo/sniff", "dojo/query", "dojo/dom", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-construct", "dojo/dom-style", "dojox/html/entities", "dijit/_Widget", "dijit/_Templated", "../kernel", "../urlUtils", "./_EventedWidget", "dojo/i18n!../nls/jsapi", "dojo/NodeList-dom"], function(s, t, p, m, q, k, C, D, u, h, e, n, r, v, w, x, E, y, z, A) {
    var B = 0;
    return t([z, w, x], {
        ...
        _showImage: function(b) {
            ...
            var c = r.get(this._gallery, "height"),
                a;
            b.linkURL && (a = n.create("a", {
                href: b.linkURL,
        ...
        _showChart: function(b, c, a, f, d) {
            ...
            a = this._chart = new a(n.create("div", {
                "class": "chart"
            }, this._mediaFrame), {
                margins: {
                    l: 4,
        ...
        _imageLoaded: function(b, c) {
            var a = b.height;
            a < c && (a = Math.round((c - a) / 2), r.set(b, "marginTop", a + "px"))
        },
        _attListHandler: function(b, c) {
            if (b === this._dfd) {
                this._dfd = null;
                var a = "";
                !(c instanceof Error) && (c && c.length) && q.forEach(c, function(b) {
                    a += "\x3cli\x3e";
                    a += "\x3ca href\x3d'" + y.addProxy(b.url) + "' target\x3d'_blank'\x3e" +
        ...
        _handleComponentsSuccess: function(b) {
            if (b) {
                ...
                !a && f && (a = "", q.forEach(f, function(b) {
                    a +=
                        "\x3ctr valign\x3d'top'\x3e";
                    a += "\x3ctd class\x3d'attrName'\x3e" + v.encode(b[0]) + "\x3c/td\x3e";
                ...
                if (c = this._dfd = p.getAttachments(r)) c.addBoth(m.hitch(this, this._attListHandler, c)), h.set(this._attachmentsList, "innerHTML", "\x3cli\x3e" + l.NLS_searching + "...\x3c/li\x3e"), k.query(".attachmentsSection", g).removeClass("hidden");
                d && d.length && (k.query(".mediaSection", g).removeClass("hidden"),
                    u.setSelectable(this._mediaFrame, !1), this._mediaInfos = d, this._mediaPtr = 0, this._updateUI(), this._displayMedia());
