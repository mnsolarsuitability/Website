...
define(["../kernel", "../lang", "../TimeExtent", "dijit/_TemplatedMixin", "dijit/_WidgetBase", "dijit/form/HorizontalSlider", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/declare", "dojo/_base/lang", "dojo/dom", "dojo/dom-style", "dojo/has", "dojo/string", "dojox/gfx", "dojox/form/RangeSlider", "dojo/i18n!../nls/jsapi", "dojo/text!dojox/form/resources/HorizontalRangeSlider.html", "dojo/text!./HistogramTimeSlider/templates/HistogramTimeSlider.html"], function(C, l, u, v, w, x, q, n, r, D, m, y, E, s, p, z, t, A, B) {
    return r([w, v], {
        ...
        constructor: function(a, c) {
            ...
            q.forEach(this.layers, function(a, c) {
        ...
        _updateDateRange: function(a) {
            ...
            c = s.substitute(t.widgets.HistogramTimeSlider.dateRange, {
                start: c,
                end: a
            });
            m.byId("histogram-range").innerHTML =
                c
        },
        _disableBins: function(a, c) {
            var b = this;
            0 === a && c === this.histogram.length ? (this.histogram[0].setFill(this._color), this.histogram[this.histogram.length - 1].setFill(this._color)) : q.forEach(this.histogram, function(d, e) {
                e < a ? d.setFill("rgb(216,216,216)") : e >= c ? d.setFill("rgb(216,216,216)") : d.setFill(b._color)
            })
        },
        _updateScaleBar: function(a) {
            this.scaleLeft ? (this.scaleLeft.clear(), this.scaleRight.clear()) : (this.scaleRight = p.createSurface("scale-bar-right", 45, 110), this.scaleLeft = p.createSurface("scale-bar-left",
                45, 110));
            var c, b;
            c = 99 < a ? 10 : 20;
            b = 99 < a / 2 ? b = 10 : 20;
        ...
        _showTipForBin: function(a, c, b) {
            ...
            if (!this._active) {
                var e =
                    new Date(this.fullTimeExtent[0] + (c - this.minVisibleIndex) * this._num_resolutions[d]),
                    e = l.substitute({
                        date: e.getTime()
                    }, this._dateTemplate);
                ...
                a = s.substitute(t.widgets.HistogramTimeSlider.count, {
                    count: a
                });
                m.byId("focusTip").innerHTML = "\x3cspan style\x3d'font-size:8pt'\x3e" + e + " to " + c + "\x3c/span\x3e \x3cbr /\x3e " + a;
                y.set("focusTip", {
                    display: "block",
                    left: b + "px",
                    top: "-10px"
