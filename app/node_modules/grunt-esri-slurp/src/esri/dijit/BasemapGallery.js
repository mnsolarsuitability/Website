...
define(["require", "dojo/_base/declare", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/lang", "dojo/_base/kernel", "dojo/_base/sniff", "dojo/has", "dojo/query", "dojo/DeferredList", "dojo/dom", "dojo/dom-construct", "dojo/dom-class", "dijit/_Widget", "dijit/_Templated", "../kernel", "../urlUtils", "../request", "../geometry/Extent", "../virtualearth/VETiledLayer", "../layers/OpenStreetMapLayer", "../layers/ArcGISTiledMapServiceLayer", "../layers/ArcGISDynamicMapServiceLayer", "../layers/WebTiledLayer", "../layers/ArcGISImageServiceLayer", "../layers/ImageServiceParameters", "./Basemap", "./_EventedWidget", "dojo/text!./templates/BasemapGallery.html"], function(t,
    u, e, n, f, p, H, I, J, v, w, g, q, x, y, l, z, h, m, k, A, B, C, D, r, s, E, F, G) {
    return u([F, x, y], {
        ...
        startup: function() {
            this.loaded ? this._refreshUI() : n.connect(this, "onLoad", f.hitch(this, function() {
                this._refreshUI()
            }))
        },
        select: function(a) {
        ...
        _buildNodeLayout: function(a) {
            ...
            n.connect(d, "onclick", f.hitch(this, "_onNodeClick", a));
            var c = a.title || "";
        ...
        _markSelected: function(a) {
            a && (e.forEach(p.query(".esriBasemapGallerySelectedNode", this.domNode), function(a) {
                q.remove(a, "esriBasemapGallerySelectedNode")
            }), (a = w.byId("galleryNode_" + a.id)) && q.add(a, "esriBasemapGallerySelectedNode"))
        },
        _select: function(a) {
        ...
        _loadAsCached: function(a) {
            ...
            var d = null;
            a.exclusionAreas && a.exclusionAreas.length && (d = [], e.forEach(a.exclusionAreas, function(a) {
                d.push({
                    minZoom: a.minZoom,
                    maxZoom: a.maxZoom,
                    minScale: a.minScale,
                    maxScale: a.maxScale,
                    geometry: new m(a.geometry)
                })
            }));
            return new B(a.url, {
                resourceInfo: a.serviceInfoResponse,
        ...
        _isUniqueId: function(a) {
            return -1 === ("," + this._getIds().toString() +
                ",").indexOf("," + a + ",") ? !0 : !1
        },
