//>>built
define(["dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/has", "../tasks/query", "../dijit/FeatureLayerQueryResult", "dojo/i18n!../nls/jsapi"], function(f, h, k, p, l, m, q) {
    return f(null, {
        queryUrl: "",
        idProperty: "id",
        data: [],
