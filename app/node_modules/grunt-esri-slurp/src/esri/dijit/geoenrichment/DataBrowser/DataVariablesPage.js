    ...
    var u = h([y], {
        ...
        G = h([A, B, C, r], {
            ...
            constructor: function() {
                this._ltr = v.isBodyLtr()
            },
            removeRow: function(a, c) {
                var b = F.findWidgets(a);
                if (b)
            ...
            buildRendering: function() {
                this.inherited(arguments);
                this.on("dgrid-select", f.hitch(this, this._onSelect));
            ...
            select: function(a, c, b) {
                ...
                if (e && e._children) {
                    ...
                    for (var f = 0; f < e.length; f++) l = this.row(e[f]), this.select(l, c, b);
                    this._lockAnimation = !1;
                    d && (b ? (g.add(d, "dgrid-selected"), this.flyAnim.fly(n(".VarLabel", d)[0], "DataBrowser_SelectVar", ["top", this._ltr ? "right" : "left"])) : g.remove(d, "dgrid-selected"))
                }
                this.inherited(arguments);
            ...
            syncOneBranchWithShoppingCart: function(a) {
                for (var c = this.shoppingCart.content, b = 0; b < a.length; b++) this.select(a[b], null, !!c[a[b].idDesc])
            },
            ...
            _onSelect: function(a) {
                if (!this._lockAnimation && this.flyAnim && a.parentType) {
                    ...
                    this.flyAnim.fly(n(".VarLabel", c)[0], "DataBrowser_SelectVar", ["top", this._ltr ? "right" : "left"])
                }
        ...
        H = h([p], {
            ...
            constructor: function(a, c) {
                ...
                this._children = [];
                this.variables = [];
                for (var b in c) c.hasOwnProperty(b) && (this.variables.push(c[b]), this._children.push(c[b]))
            },
            getLabel: function() {
                return this._label
            },
    ...
    return h([x, r], {
        ...
        _setSelectedCollectionsAttr: function(a) {
            ...
            if (a) {
                var c = 0;
                this._model = [];
                for (var b = {}, d, e, l = 0; l < a.length; l++)
                    if (a[l].variables)
                        for (var g = 0; g <
                            a[l].variables.length; g++) {
                            d = a[l].variables[g];
                            var k = d.fieldCategory;
                            e = d.idDesc;
                            b[k] || (b[k] = {});
                            b[k][e] = d
                        }
                    for (var h in b)
                        if (b.hasOwnProperty(h)) {
                            for (e in b[h]) b[h].hasOwnProperty(e) && c++;
                            this._model.push(new H(h, b[h]))
                        }
                ...
                if (this._grid) this._grid.set("store", a);
                    ...
                    D.after(this._grid, "expand", f.hitch(this, this.invoke, "resize"));
                    this._grid.startup()
                }
            }
        },
        ...
        _renderCheckBox: function(a, c, b, d) {
            ...
            d && (g.add(b.children[0], "DataVariablesPage_VarCheck"), d = m.create("div", {
                ...
                k(d, "click", f.hitch(this, this._toggleTooltip, d, a)), k(d, "mouseenter", f.hitch(this, this._showTooltip, d, a)), k(d, "mouseover", f.hitch(this, this._showTooltip, d, a)), k(d, "mouseleave", f.hitch(this, this._hideTooltip, d, a)), k(d, "mousedown,touchstart,MSPointerDown,dgrid-cellfocusin", function(a) {
        ...
        _toggleTooltip: function(a, c, b) {
            ...
            this._icon ? this._hideTooltip() : this._showTooltip(a,
                c, b)
        },
        _showTooltip: function(a, c, b) {
            ...
            b.stopPropagation && b.stopPropagation();
            k.once(E.doc, "click", f.hitch(this, this._hideTooltip))
        },
        ...
        onRemoveElementFromShoppingCart: function(a) {
            for (var c, b = 0; b < this._grid.store.data.length; b++) {
                for (var d = 0; d < this._grid.store.data[b].variables.length; d++)
                    if (a === this._grid.store.data[b].variables[d].idDesc) {
                        c =
                            this._grid.store.data[b].variables[d];
                        break
                    }
                if (c) break
            }
            c && this._grid.select(c, null, !1)
        },
        syncWithShoppingCart: function() {
            var a, c = this.shoppingCart.content,
                ...
                d = !1;
            if (this._grid)
                for (var e = 0; e < this._grid.store.data.length; e++) {
                    for (var d = !0, f = 0; f < this._grid.store.data[e].variables.length; f++) a = this._grid.store.data[e].variables[f], b = !!c[a.idDesc], this._grid.select(a, null, b), b || (d = !1);
                    if (d && (a = this._grid.row(this._grid.store.data[e]).element)) g.add(a, "dgrid-selected"), (a = n(".dijitCheckBox", a)[0]) && g.add(a,
