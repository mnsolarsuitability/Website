    ...
    return l("esri.dijit.geoenrichment.InfographicsCarousel", [y, E], {
        ...
        _getReports: function() {
            if (this.options) {
                ...
                a && (this._pendingReload = !0, this._showProgress(), this.options.getItems(a).then(d.hitch(this, this._fillReports), d.hitch(this, this._onDataError)))
            }
        },
        ...
        _onDataReady: function(a) {
            ...
            b ? (F(this._infographic.domNode, this._pendingAnimation, this.animDuration), this._pendingAnimation = null, this.onDataReady(a)) : this._countryForStudyArea || (this._infographic.set("variables",
                null), a.stop(), this._getCountry())
        },
