...
define(["../../declare", "dojo/_base/lang", "dojo/dom-class", "./_Wizard", "../../tasks/geoenrichment/EnrichParameters", "../../tasks/geoenrichment/RingBuffer", "./EnrichOptionsPage", "./DataBrowser", "dojo/i18n!../../nls/jsapi"], function(l, f, m, n, p, q, r, s, g) {
    return l("esri.dijit.geoenrichment.EnrichConfig", [n], {
        ...
        startup: function() {
            ...
            b.on("back,cancel", f.hitch(this,
                this._onBack));
            b.on("ok", f.hitch(this, this._applyVariables));
            this._loadDataBrowser()
        },
        _onDataCollectionSelect: function() {
            var b = !1,
                c = this.pages.d.get("selection"),
                a;
            for (a in c)
                if (c[a]) {
                    b = !0;
        ...
        _applyVariables: function() {
            ...
            for (var b = this.fieldsMap || {}, c = {}, a = this.selectedIDs = this.pages.d.get("selection"), e = 0; e < a.length; e++) {
                var d = a[e];
                c[d] = b[d] || ""
            }
            this.fieldsMap =
                c;
            this.pages.o.set("fieldsMap", c);
            this.loadPage("o")
        },
        _onBack: function() {
            this.onBack()
        ...
        _finish: function() {
            ...
            var b = this.fieldsMap = this.pages.o.get("fieldsMap"),
                c = [];
            this.enrichParams.variables = [];
            for (var a, e = 0; e < this._dataCollections.length; e++) {
                var d = this._dataCollections[e],
                    g = !0,
                    h = [];
                for (a = 0; a < d.variables.length; a++) {
                    var k = d.id + "." + d.variables[a].id;
                    f.isString(b[k]) ?
                        h.push(k) : g = !1
                }
                if (g) this.enrichParams.variables.push(d.id + ".*"), c.push(d);
                else if (0 < h.length) {
                    for (a = 0; a < h.length; a++) this.enrichParams.variables.push(h[a]);
                    c.push(d)
                }
            }
            this.onFinish(this.enrichParams, b, c)
        },
        onFinish: function(b, c, a) {}
    })
});