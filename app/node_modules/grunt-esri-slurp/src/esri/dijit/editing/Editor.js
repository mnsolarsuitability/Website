    ...
    var n = w([A, B], {
        ...
        _onEditFeature: function(a, b) {
            if (a = (d.isArray(a) ?
                ...
                if (!this._customAttributeInspector && !this._updateAttributeDisabled(a)) {
                    ...
                    } else this._settings.map.infoWindow.setTitle(this._layer ?
                        this._layer.name : r.widgets.attributeInspector.NLS_title);
        ...
        _applyEdits: function(a, b) {
            ...
            if (!(0 >= a.length)) {
                ...
                var c = [];
                h.forEach(a, function(a) {
                    a.layer && c.push(a.layer.applyEdits(a.adds,
                        a.updates, a.deletes))
                });
        ...
        _redo: function() {
            this._settings.undoManager && !this._settings._isApplyEditsCall &&
                (this._editToolbar.deactivate(), this._undoRedo = !0, this._settings.undoManager.redo())
        },
        ...
        _autoComplete: function(a, b) {
            ...
            this._selectFeatures(c, f, d.hitch(this, function(c) {
                !c || 0 >= c.length ? b && b([a]) : this._settings.geometryService.autoComplete(C.getGeometries(c), this._toPolylines([f.geometry]),
                    function(a) {
                        b && b(a)
                    })
            }))
        ...
        _updateSelection: function(a) {
            ...
            this._selectionHelper.selectFeaturesByGeometry(this._settings.layers, b, t.SELECTION_NEW, d.hitch(this, function(a) {
                var e = h.some(a, d.hitch(this, function(a) {
                    return a == c
                }));
                c && !e ? (a = c.getLayer(), this._isValidLayer(a) ? (e = new s,
                    e.objectIds = [c.attributes[a.objectIdField]], this._selectionHelper.selectFeatures([a], e, t.SELECTION_ADD, d.hitch(this, function(a) {
            ...
            c && this._isTextSymbolPoint(c) && (a = 0 | m.MOVE | m.ROTATE | m.SCALE | m.EDIT_TEXT, this._editToolbar.activate(a, c))
        },
        _updatePopupButtons: function(a) {
            if (!this._usePopup || !a) this._currentFeatureCount = this._popupFeatures =
                null;
            else {
                var b = a.length;
        ...
        _toDrawTool: function(a, b) {
            ...
            switch (a) {
                ...
                default:
                    var d = e.POINT;
                    "esriGeometryPolyline" === c ? (d = e.POLYLINE, this._settings.createOptions.polylineDrawTools[0] ===
                        n.CREATE_TOOL_FREEHAND_POLYLINE && (d = e.FREEHAND_POLYLINE)) : "esriGeometryPolygon" === c && (d = e.POLYGON, this._settings.createOptions.polygonDrawTools[0] === n.CREATE_TOOL_FREEHAND_POLYGON && (d = e.FREEHAND_POLYGON));
                    return d
            }
        },
