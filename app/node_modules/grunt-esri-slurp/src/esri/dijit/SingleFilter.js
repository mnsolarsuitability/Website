...
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/json", "dojo/has", "dojo/json", "dojo/string", "dojo/number", "dojo/dom", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/dom-class", "dojo/_base/event", "dojo/Evented", "dojo/data/ItemFileWriteStore", "dojo/date/locale", "dojo/parser", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/TextBox", "dijit/form/FilteringSelect", "dijit/form/RadioButton", "dijit/form/DateTextBox", "dijit/form/NumberTextBox", "../kernel", "../lang", "../tasks/GenerateRendererTask", "../tasks/UniqueValueDefinition", "../tasks/GenerateRendererParameters", "../layers/FeatureLayer", "../layers/GeoRSSLayer", "dojo/i18n!../nls/jsapi", "dojo/text!./templates/SingleFilter.html"], function(S, C, n, q, h, T, U, V, D, v, k, s, W, l, y, X, Y, E, t, u, F, G, H, I, J, K, f, L, w, Z, z, A, B, r, x, M, N, O, P, Q, R) {
    return C([G, H, I, J, K, E], {
        ...
        _onChangeOperator: function(a, b, c) {
            ...
            else if ("date" === c && (a === this.i18n.dateOperatorInTheLast || a === this.i18n.dateOperatorNotInTheLast)) b.createValueInTheLastDate();
            else if (a === this.i18n.stringOperatorIsBlank || a === this.i18n.dateOperatorIsBlank || a === this.i18n.numberOperatorIsBlank || a === this.i18n.stringOperatorIsNotBlank || a === this.i18n.dateOperatorIsNotBlank || a === this.i18n.numberOperatorIsNotBlank) b.createValueIsBlank(), b.disableOptions();
            else switch (c) {
                case "string":
        ...
        onClickShowHideInteractive: function(a) {
            this.interactiveCheck.disabled || ("none" === s.set(this.interactiveSpace,
                "display") ? (s.set(this.interactiveSpace, "display", "block"), this.interactiveArrow.innerHTML = "\x26nbsp;\x26#9650;") : (s.set(this.interactiveSpace, "display", "none"), this.interactiveArrow.innerHTML = "\x26nbsp;\x26#9660;"))
        },
        ...
        _showUniqueList: function(a, b, c) {
            ...
            if (10.1 <= this.version) {
                ...
                if (this.uniqueValuesResults[this.mapLayer.id +
                        "_" + c]) this.onGenerateRendererResults(b, a, this.uniqueValuesResults[this.mapLayer.id + "_" + c]);
        ...
        onGenerateRendererResults: function(a, b, c) {
            ...
            c.length ? ("date" === e ? (c = q.map(c, function(a) {
                ...
                return "esriFieldTypeDouble" === f || "esriFieldTypeSingle" ===
                    f ? parseFloat(a) : parseInt(a, 10)
            }), c = c.sort(function(a, b) {
        ...
        generateRendererUniqueValues: function(a, b, c, d) {
            ...
            this.mapLayer instanceof P ? b = new x(this.mapLayer) : this.mapLayer instanceof O && !this.mapLayer.url ? b = new x(this.mapLayer) : this.hasDynamicLayers(this.mapLayer) ? (e = this.mapLayer.layerDefinitions &&
                this.mapLayer.layerDefinitions[this.mapLayer.id] ? this.mapLayer.layerDefinitions[this.mapLayer.id] : null, a.where = e ? e : null, b = new x(this.mapLayer.url + "/dynamicLayer", {
        ...
        clearAttributeValueDijits: function() {
            this.valueHandlers && 0 !== this.valueHandlers.length &&
                (q.forEach(this.valueHandlers, n.hitch(this, function(a) {
                    console.log("disconnecting", a);
                    h.disconnect(a)
                })), this.valueHandlers = [], f.byId(this.id + ".value") ? f.byId(this.id + ".value").destroy() : k.byId(this.id + ".value") && this.getAttrValContNode().removeChild(k.byId(this.id + ".value")), f.byId(this.id + ".value1") ? f.byId(this.id + ".value1").destroy() : k.byId(this.id + ".value1") && this.getAttrValContNode().removeChild(k.byId(this.id + ".value1")), f.byId(this.id + ".value2") ? f.byId(this.id + ".value2").destroy() : k.byId(this.id +
                    ".value2") && this.getAttrValContNode().removeChild(k.byId(this.id + ".value2")), f.byId(this.id + ".valueFields") && f.byId(this.id + ".valueFields").destroy(), f.byId(this.id + ".valueUnique") && f.byId(this.id + ".valueUnique").destroy())
        },
        ...
        buildEditUIOperator: function(a,
            b, c) {
            switch (a.fieldObj.shortType) {
                case "string":
                    b.fillOperatorList(this.stringOperatorStore, a.operator);
                    break;
                case "date":
        ...
        getOperatorItemByName: function(a,
            b, c, d) {
            a.fetch({
                query: b,
                onComplete: n.hitch(this, function(a) {
