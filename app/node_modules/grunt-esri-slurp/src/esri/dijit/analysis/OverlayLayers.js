    ...
    return s([t, u, v, w, x, y], {
        ...
        _handleSaveBtnClick: function(a) {
            if (this._form.validate()) {
                ...
                var b = {},
                    e;
                a.InputLayer = d.toJson(h.constructAnalysisInputLyrObj(this.inputLayer));
                "0" !== this._overlayFeaturesSelect.get("value") && (e = this.overlayLayer[this._overlayFeaturesSelect.get("value") - 1], a.OverlayLayer = d.toJson(h.constructAnalysisInputLyrObj(e)));
        ...
        _handleShowCreditsClick: function(a) {
            ...
            if (this._form.validate()) {
                ...
                if ("0" !== this._overlayFeaturesSelect.get("value")) {
                    var b =
                        this.overlayLayer[this._overlayFeaturesSelect.get("value") - 1];
                    a.OverlayLayer = d.toJson(h.constructAnalysisInputLyrObj(b))
                }
                a.OverlayType = this.get("overlayType");
                this.returnFeatureCollection || (a.OutputName = d.toJson({
                    serviceProperties: {
        ...
        _sortbyGeometryType: function(a, b) {
            ...
            if ("esriGeometryPoint" === a.geometryType) return -1;
        ...
        _buildUI: function() {
            ...
            this.overlayLayer && (this.overlayLayer = l.filter(this.overlayLayer, function(a) {
                    if (this.inputLayer !== a && ("esriGeometryPolygon" === a.geometryType || "esriGeometryPoint" === a.geometryType || "esriGeometryPolyline" === a.geometryType)) return !0
                }, this), this.overlayLayer.sort(c.hitch(this, this._sortbyGeometryType)), this._selectedIndex =
                1, l.forEach(this.overlayLayer, function(a, b) {
            ...
            f.set(this._chooseExtentDiv, "display", !0 ===
                this.showChooseExtent ? "inline-block" : "none");
        ...
        _updateOutputType: function() {
            ...
            b ? k.add(this._outputTypeLabel, "esriAnalysisTextDisabled") : k.remove(this._outputTypeLabel, "esriAnalysisTextDisabled");
