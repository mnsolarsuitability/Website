    ...
    return p([r, s, t, u, v, w], {
        ...
        _handleSaveBtnClick: function() {
            if (this._form.validate() && this.expressionGrid.validate()) {
                ...
                c = [];
                c = h.map(b.inputLayers, function(a) {
        ...
        _handleShowCreditsClick: function(a) {
            ...
            a = {};
            var d, c;
            !this._form.validate() || !this.expressionGrid.validate() ? (f.set(this._showCreditsLink, "color", "grey"), f.set(this._showCreditsLink, "cursor", "default")) : (f.set(this._showCreditsLink, "color", ""), f.set(this._showCreditsLink,
                "cursor", ""), d = this.expressionGrid.get("expressionMap"), a.expressions = e.toJson(d.expressions), c = [], c = h.map(d.inputLayers, function(a) {
                return g.constructAnalysisInputLyrObj(a)
        ...
        _buildUI: function() {
            ...
            f.set(this._chooseExtentDiv, "display", !0 === this.showChooseExtent ? "inline-block" : "none");
