//>>built
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/json", "dojo/_base/fx", "dojo/has", "dojo/json", "dojo/string", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/dom-class", "dojo/fx/easing", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/Button", "dijit/form/CheckBox", "dijit/form/Form", "dijit/form/Select", "dijit/form/TextBox", "dijit/form/ValidationTextBox", "dijit/layout/ContentPane", "dijit/form/ComboBox", "../../kernel", "../../lang", "./AnalysisBase", "./CreditEstimator", "./utils", "dojo/i18n!../../nls/jsapi", "dojo/text!./templates/SummarizeWithin.html"], function(w, x, e, k, p, g, r, H, I, l, h, d, m, y, q, s, z, A, B, C, D, t, J, K, L, u, M, N, O, P, Q, v, E, R, n, F, G) {
    return x([z, A, B, C, D, E], {
        ...
        postCreate: function() {
            ...
            this._outputLayerInput.set("validator",
                e.hitch(this, this.validateServiceName));
            this._buildUI()
        },
        startup: function() {},
        _onClose: function(a) {
        ...
        _handleSaveBtnClick: function() {
            if (this._form.validate())
                if (!this._sumMetricCheck.get("checked") && 0 === this.get("summaryFields").length) this._showMessages(this.i18n.statsRequiredMsg);
                    ...
                    "0" !== this._groupBySelect.get("value") && (a.groupByField = this._groupBySelect.get("value"), this.resultParameter = ["resultLayer", "groupBySummary"], a.minorityMajority = this.get("minorityMajority"),
                        a.percentPoints = this.get("percentPoints"));
                    this.showChooseExtent && this._useExtentCheck.get("checked") && (a.context = g.toJson({
                        extent: this.map.extent._normalize(!0)
                    }));
        ...
        _handleGroupBySelectChange: function(a) {
            a = "0" === a;
            q.toggle(this._minmajorityLabel, "esriAnalysisTextDisabled", a);
            q.toggle(this._percentPointsLabel, "esriAnalysisTextDisabled", a);
        ...
        _buildUI: function() {
            ...
            this.summaryLayer && this._layersSelect.set();
            ...
            k.forEach(this.summaryFields, function(a) {
                ...
                e.hitch(this._currentAttrSelect, this._handleAttrSelectChange,
                    a[0])();
        ...
        _removeStatsRow: function(a) {
            k.forEach(t.findWidgets(a), function(a) {
                a.destroyRecursive()
            });
            m.destroy(a)
        },
        ...
        _getSummaryFieldsAttr: function() {
            var a = "",
                b = [];
            y(".statsSelect", this.domNode).forEach(function(c) {
                var f;
                c = t.byNode(c);
        ...
        _setGroupBySelectAttr: function(a) {
            ...
            k.forEach(c, function(a, c) {
                -1 !== k.indexOf(["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeString", "esriFieldTypeDate"], a.type) &&
