...
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/Color", "dojo/_base/connect", "dojo/_base/json", "dojo/_base/fx", "dojo/has", "dojo/json", "dojo/string", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/fx/easing", "dojo/dom-class", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/Button", "dijit/form/CheckBox", "dijit/form/Form", "dijit/form/Select", "dijit/form/TextBox", "dijit/form/ToggleButton", "dijit/form/ValidationTextBox", "dijit/layout/ContentPane", "dijit/form/ComboBox", "dijit/form/NumberSpinner", "dijit/Dialog", "dojox/form/CheckedMultiSelect", "../../kernel", "../../lang", "../../layers/FeatureLayer", "./AnalysisBase", "./utils", "./CreditEstimator", "./ExpressionForm", "../../geometry/Extent", "../../geometry/ScreenPoint", "../../symbols/CartographicLineSymbol", "../../symbols/SimpleMarkerSymbol", "../../symbols/SimpleLineSymbol", "../../symbols/SimpleFillSymbol", "../../tasks/query", "../../renderers/jsonUtils", "dojo/i18n!../../nls/jsapi", "dojo/text!./templates/FindSimilarLocations.html"], function(A, B, e, f, m, s, d, t, M, N, g, h, n, O, P, u, C, D, E, F, G, H, Q, R, S, T, U, V, W, X, Y, Z, $, aa, ba, ca, v, k, I, l, da, ea, J, w, r, x, p, y, q, K, z, L) {
    return B([D, E, F, G, H, I], {
        ...
        _onClose: function(a) {
            ...
            this.selectionLayer && (this.selectionLayer.clearSelection(), this.map.removeLayer(this.selectionLayer), this.selectionLayer =
                null);
        ...
        _handleSaveBtnClick: function() {
            if (this._form.validate()) {
                ...
                var a = {},
                    b = {},
                    c;
                a.inputLayer = d.toJson(l.constructAnalysisInputLyrObj(this.inputLayer));
                this.get("InputQuery") && (a.inputQuery = this.inputQuery);
                a.searchLayer = d.toJson(l.constructAnalysisInputLyrObj(this.get("searchLayer")));
        ...
        _handleShowCreditsClick: function(a) {
            ...
            a = {};
            var b;
            this._form.validate() && (a.inputLayer = d.toJson(l.constructAnalysisInputLyrObj(this.inputLayer)), this.get("InputQuery") && (a.inputQuery = this.inputQuery), a.searchLayer = d.toJson(l.constructAnalysisInputLyrObj(this.get("searchLayer"))),
                a.analysisFields = this.get("analysisFields"), a.numberOfResults = this.get("numberOfResults"), this.returnFeatureCollection || (a.OutputName = d.toJson({
                    serviceProperties: {
                        name: this._outputLayerInput.get("value")
                    }
                })), this.showChooseExtent && this._useExtentCheck.get("checked") && (a.context = d.toJson({
                    ...
                    outSR: this.map.spatialReference
                }, this.showChooseExtent && (b.extent = this.map.extent._normalize(!0)), a.context = d.toJson(b)), this.getCreditsEstimate(this.toolName,
        ...
        _buildUI: function() {
            ...
            this.signInPromise.then(e.hitch(this, l.initHelpLinks, this.domNode, this.showHelp, {
                analysisGpServer: this.analysisGpServer
            }));
            n.set(this._toolDescription, "innerHTML", g.substitute(this.i18n.toolDefine, {
                layername: this.inputLayer.name
            }));
            this.outputLayerName ? this._outputLayerInput.set("value", this.outputLayerName) : this._outputLayerInput.set("value",
                g.substitute(this.i18n.outputLayerName, {
                    analysisLayerName: this.inputLayer.name
                }));
        ...
        _onSelectionLayerLoad: function(a, b) {
            ...
            this.map.addLayer(b);
            "esriGeometryPoint" === b.geometryType || "esriGeometryMultPoint" === b.geometryType ? (c = new x, c.setStyle(x.STYLE_TARGET), c._setDim(16, 16, 0), c.setOutline(new r(p.STYLE_SOLID, new m([0, 255, 255]), 2, r.CAP_ROUND, r.JOIN_ROUND)), c.setColor(new m([0, 0, 0, 0])), b.setSelectionSymbol(c)) : "esriGeometryPolyline" === b.geometryType ? b.setSelectionSymbol(new p(p.STYLE_SOLID, new m([0, 255, 255]), 2)) : "esriGeometryPolygon" ===
                b.geometryType && b.setSelectionSymbol(new y(y.STYLE_NULL, new p(p.STYLE_SOLID, new m([0, 255, 255]), 2), new m([0, 0, 0, 0])))
        },
        ...
        _handleExpressionFormAdd: function(a) {
            ...
            if ("add" === a.action || "edit" === a.action) {
                n.set(this._filterLabel, "innerHTML", g.trim(a.expression._attributeText));
                this._expression = a;
                var b;
                b = new q;
                b.returnGeometry = !0;
        ...
        _handleSelectionButtonClick: function(a) {
            a && !this._mapClickHandle ? (this._mapClickHandle = this.map.on("click", e.hitch(this, this._handleMapClick)), this.emit("selecttool-activate", {}), this._isAttrFlag = !1) : (this._mapClickHandle.remove(), this._mapClickHandle = null, this.emit("selecttool-deactivate", {}))
        },
        ...
        _handleInputLayerSelectionComplete: function(a) {
            ...
            !this._isAttrFlag && 0 < a.length && (b = "", f.map(a, function(a) {
                ...
                return a.attributes[this.selectionLayer.objectIdField]
            }, this), b = b.substring(0, b.lastIndexOf(" OR ")), n.set(this._filterLabel, "innerHTML", g.substitute(this.i18n.selectedFeaturesLabel, {
                total: a.length
            })), this.set("inputQuery", b), this._expression = null, this.validate());
            !this._isAttrFlag && 0 === a.length && (n.set(this._filterLabel, "innerHTML", ""), this.set("inputQuery", null), this._expression = null, this.validate())
        }
    })
});