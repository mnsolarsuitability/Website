...
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/json", "dojo/_base/fx", "dojo/has", "dojo/json", "dojo/string", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/dom-class", "dojo/fx/easing", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/Button", "dijit/form/CheckBox", "dijit/form/Form", "dijit/form/RadioButton", "dijit/form/Select", "dijit/form/TextBox", "dijit/form/ValidationTextBox", "dijit/layout/ContentPane", "dijit/form/ComboBox", "../../kernel", "../../lang", "./AnalysisBase", "./CreditEstimator", "./utils", "dojo/i18n!../../nls/jsapi", "dojo/text!./templates/MergeLayers.html"], function(v, w, f, l, n, h, r, I, J, p, g, s, k, x, y, t, z, A, B, C, D, u, K, L, M, N, q, O, E, P, Q, R, S, F, T, m, G, H) {
    return w([z, A, B, C, D, F], {
        ...
        destroy: function() {
            ...
            l.forEach(this._pbConnects, n.disconnect);
        ...
        _handleShowCreditsClick: function(a) {
            ...
            if (this._form.validate()) {
                ...
                a.InputLayer = h.toJson(m.constructAnalysisInputLyrObj(this.inputLayer));
                a.MergeLayer = h.toJson(m.constructAnalysisInputLyrObj(b));
        ...
        _handleSaveBtnClick: function() {
            if (this._form.validate()) {
                ...
                a.InputLayer = h.toJson(m.constructAnalysisInputLyrObj(this.inputLayer));
                a.MergeLayer =
                    h.toJson(m.constructAnalysisInputLyrObj(c));
                a.MergingAttributes = h.toJson(this.get("mergingAttributes"));
                this.returnFeatureCollection || (a.OutputName = h.toJson({
                    serviceProperties: {
                        name: this._outputLayerInput.get("value")
        ...
        _handleLayerChange: function(a) {
            this.outputLayerName = p.substitute(this.i18n.outputLayerName, {
                layername: this.inputLayer.name,
        ...
        _handleAttrSelectChange: function(a, b) {
            var c, d;
            "0" !== b && (c = a.get("statisticSelect"), "0" !== c.get("value") && (!c.get("isnewRowAdded") && null !== this._includedMergeFields && "0" !== a.get("value")) && (this._includedMergeFields.push(a.get("value")), d = this.mergeLayers[this._mergeLayersSelect.get("value")].fields.length, this._includedMergeFields.length !== d - 1 && (d = c.get("removeTd"), g.set(d, "display", "block"), d = c.get("referenceWidget"), f.hitch(d, d._createMergeFieldsRow()), c.set("isnewRowAdded", !0))))
        },
        _handleAttrMatchSelectChange: function(a,
            b) {
            if ("0" !== b && "0" !== a.get("value")) {
                ...
                e !== f ? -1 !== l.indexOf(["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"], e) && -1 !== l.indexOf(["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"], f) ? (this._handleCloseMsg(),
                    this.set("disableRunAnalysis", !1)) : (this._showMessages(this.i18n.fieldTypeMatchValidationMsg), this.set("disableRunAnalysis", !0)) : (this._handleCloseMsg(), this.set("disableRunAnalysis", !1))
            }
        },
        _handleStatsValueUpdate: function(a, b, c, d) {
            ...
            a && (b = a.get("statisticSelect"), c = a.get("attributeMatchSelect"), e = a.get("attributeRenameBox"), "Rename" === d ? (g.set(e.domNode.parentNode, {
                    ...
                    "padding-left": 0,
                    "padding-right": 0
                }), e.domNode.style.display = "block", e.set("required", !0), c.domNode.style.display = "none",
                g.set(b.domNode.parentNode, "width", "34%"), g.set(a.domNode.parentNode, "width", "35%")) : "Remove" === d || "0" === d ? (e.domNode.style.display = "none", e.set("required", !1), c.domNode.style.display = "none", g.set(b.domNode.parentNode, "width", "44%"), g.set(a.domNode.parentNode, "width", "55%"), g.set(e.domNode.parentNode, "display", "none")) : (g.set(c.domNode.parentNode, {
                display: "",
                "padding-left": 0,
                "padding-right": 0
            }), e.domNode.style.display = "none", e.set("required", !1), c.domNode.style.display = "table", g.set(b.domNode.parentNode,
                "width", "34%"), g.set(a.domNode.parentNode, "width", "35%")), "0" !== a.get("value") && "0" !== d && (!b.get("isnewRowAdded") && null !== this._includedMergeFields && "0" !== a.get("value")) && (this._includedMergeFields.push(a.get("value")), a = this.mergeLayers[this._mergeLayersSelect.get("value")].fields.length, this._includedMergeFields.length !== a - 1 && (a = b.get("removeTd"), g.set(a, "display", "block"), a = b.get("referenceWidget"), f.hitch(a, a._createMergeFieldsRow()), b.set("isnewRowAdded", !0))))
        },
        _save: function() {},
        _buildUI: function() {
            this._loadConnections();
            m.initHelpLinks(this.domNode, this.showHelp);
            this.inputLayer && s.set(this._mergeLayersDescription, "innerHTML", p.substitute(this.i18n.mergeLayersDefine, {
                layername: this.inputLayer.name
            }));
            ...
            l.forEach(this.mergingAttributes, function(b) {
                b = b.split(" "); - 1 === a.indexOf(b[0]) && (this._currentAttrSelect.set("value", b[0]), f.hitch(this._currentAttrSelect, this._handleAttrSelectChange, b[0])(), this._currentStatsSelect.set("value", b[1]), f.hitch(this._currentStatsSelect, this._handleStatsValueUpdate, "value", "", b[1])(), "Rename" === b[1] ? this._currentAttrMatchSelect.set("value", b[2]) : "Match" ===
                    b[1] && this._currentAttrRenameBox.set("value", b[2]), a.push(b[0]))
            }, this);
        ...
        _createMergeFieldsRow: function() {
            ...
            n.connect(e, "onChange", f.hitch(this, this._handleAttrMatchSelectChange, b));
            b.set("statisticSelect", d);
            b.set("attributeRenameBox", g);
            b.set("attributeMatchSelect",
                e);
            n.connect(b, "onChange", f.hitch(this, this._handleAttrSelectChange, b));
            h = k.create("td", {
            ...
            n.connect(c, "onclick", f.hitch(this, this._removeMergeFieldsRow, a));
        ...
        _removeMergeFieldsRow: function(a) {
            l.forEach(u.findWidgets(a), function(a, c) {
                if (0 === c) {
        ...
        _setAttributesAttr: function(a) {
            if (a.layer) {
                ...
                l.forEach(a, function(a) {
                    a.name !== b.objectIdField &&
                        -1 === this._includedMergeFields.indexOf(a.name) && c.addOption({
                            value: a.name,
                            label: a.name
                        })
                }, this)
        ...
        _getMergingAttributesAttr: function() {
            ...
            x(".statsSelect", this.domNode).forEach(function(g) {
                ...
                "0" !== d.get("value") && "0" !== c.get("value") && ("Remove" === c.get("value") ? (a += d.get("value") + " " + c.get("value") + ";", b.push(d.get("value") + " " + c.get("value"))) : "Rename" === c.get("value") ? (a += d.get("value") + " " + c.get("value") + " " + f.get("value") + ";", b.push(d.get("value") + " " + c.get("value") + " " + f.get("value"))) : (a += d.get("value") + " " + c.get("value") + " " + e.get("value") + ";", b.push(d.get("value") + " " + c.get("value") +
                    " " + e.get("value"))))
            });
            return b
        },
        ...
        validateServiceName: function(a) {
            var b = /(:|&|<|>|%|#|\?|\\|\"|\/|\+)/.test(a);
            return 0 === a.length || 0 === p.trim(a).length ? (this._outputLayerInput.set("invalidMessage", this.i18n.requiredValue), !1) : b ? (this._outputLayerInput.set("invalidMessage",
                this.i18n.invalidServiceName), !1) : 128 < a.length ? (this._outputLayerInput.set("invalidMessage", this.i18n.invalidServiceNameLength), !1) : !0
        },
