...
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/Color", "dojo/_base/json", "dojo/has", "dojo/json", "dojo/string", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/dom-class", "dojo/number", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/Button", "dijit/form/CheckBox", "dijit/form/Form", "dijit/form/Select", "dijit/form/TextBox", "dijit/form/NumberSpinner", "dijit/form/ValidationTextBox", "dijit/layout/ContentPane", "dijit/form/ComboBox", "dijit/Dialog", "../../kernel", "../../lang", "./AnalysisBase", "../../symbols/SimpleFillSymbol", "../../symbols/SimpleLineSymbol", "../../toolbars/draw", "../PopupTemplate", "../../layers/FeatureLayer", "../../graphic", "./utils", "./CreditEstimator", "../../symbols/PictureMarkerSymbol", "dijit/form/HorizontalSlider", "dijit/form/HorizontalRule", "dijit/form/HorizontalRuleLabels", "dojo/i18n!../../nls/jsapi", "dojo/text!./templates/InterpolatePoints.html"], function(x, y, g, h, m, z, k, J, K, p, d, A, L, M, f, n, B, C, D, E, F, N, O, P, Q, R, S, T, U, V, W, X, Y, q, G, s, t, r, Z, u, v, l, $, H, aa, ba, ca, w, I) {
    return y([B, C, D, E, F, G], {
        ...
        _buildUI: function() {
            ...
            this.classificationType && this._classifySelect.set("value",
            ...
            if (this.boundingPolygonLayers) {
                ...
                h.forEach(this.boundingPolygonLayers, function(a, e) {
                    "esriGeometryPolygon" === a.geometryType && (b = this.get("boundingPolygonLayer") && this.get("boundingPolygonLayer").name ===
                        a.name, this._boundingAreaSelect.addOption({
                            value: e + 1,
                            label: a.name,
                            selected: b
                        }))
            ...
            this.showSelectFolder && this.getFolderStore().then(g.hitch(this, function(a) {
                this.folderStore =
                    a;
                l.setupFoldersUI({
        ...
        _handleClassifySelectChange: function(a) {
            ...
            d.set(this._manualOptionInputRow, "display", "Manual" === a ? "block" :
                "none");
            d.set(this._manualOptionLabelRow, "display", "Manual" === a ? "block" : "none")
        },
        _loadConnections: function() {
            this.on("start", g.hitch(this, "_onClose", !1));
        ...
        _addFeatures: function(a) {
            ...
            if (0 === this.boundingPolygonLayers.length || this.boundingPolygonLayers[this.boundingPolygonLayers.length - 1] !== this._featureLayer) b = this.boundingPolygonLayers.push(this._featureLayer), c = this._boundingAreaSelect.getOptions(), this._boundingAreaSelect.removeOption(c),
        ...
        _addPointFeatures: function(a) {
            ...
            if (0 === this.predictAtPointLayers.length || this.predictAtPointLayers[this.predictAtPointLayers.length - 1] !== this._pointfeatureLayer) b = this.predictAtPointLayers.push(this._pointfeatureLayer),
                c = this._predictPointSelect.getOptions(), this._predictPointSelect.removeOption(c), c = h.map(c, function(a) {
                    a.selected = !1;
                    return a
                }), this._predictPointSelect.addOption({
                    value: b,
        ...
        _setFieldsAttr: function(a) {
            ...
            h.forEach(a.fields, function(e, d) {
                e.name !== a.objectIdField && -1 !== h.indexOf(["esriFieldTypeSmallInteger", "esriFieldTypeInteger", "esriFieldTypeSingle", "esriFieldTypeDouble"], e.type) && (b = {
                    value: e.name,
        ...
        _getPredictAtPointLayerAttr: function() {
            this._predictPointSelect && (this.predictAtPointLayer = null, "-1" !== this._predictPointSelect.get("value") && (this.predictAtPointLayer = this.predictAtPointLayers[this._predictPointSelect.get("value") - 1]));
        ...
        _getOutputPredictionErrorAttr: function() {
            this._outoutPredictionsErrCheck && (this.outputPredictionError =
                this._outoutPredictionsErrCheck.get("checked"));
        ...
        _setMapAttr: function(a) {
            ...
            this._pointtoolbar =
                new r(this.map);
            m.connect(this._pointtoolbar, "onDrawEnd", g.hitch(this, this._addPointFeatures))
        },
