...
define(["require", "dojo/_base/declare", "dojo/_base/lang", "dojo/_base/array", "dojo/_base/connect", "dojo/_base/json", "dojo/has", "dojo/json", "dojo/string", "dojo/dom-style", "dojo/dom-attr", "dojo/dom-construct", "dojo/query", "dojo/dom-class", "dojo/number", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_OnDijitClickMixin", "dijit/_FocusMixin", "dijit/registry", "dijit/form/Button", "dijit/form/CheckBox", "dijit/form/Form", "dijit/form/Select", "dijit/form/TextBox", "dijit/form/ValidationTextBox", "dijit/layout/ContentPane", "dijit/form/ComboBox", "../../kernel", "../../lang", "./AnalysisBase", "./CreditEstimator", "./utils", "./TrafficTime", "dojo/i18n!../../nls/jsapi", "dojo/text!./templates/CreateDriveTimeAreas.html"], function(s, t, c, h, k, e, C, D, f, p, u, E, F, l, m, v, w, x, y, z, G, H, I, J, K, L, M, N, O, P, q, A, Q, n, R, r, B) {
    return t([v, w, x, y, z, A], {
        ...
        _handleDistanceTypeChange: function(a) {
            ...
            b && (p.set(this._useTrafficLabelRow, "display", "time" === b && "driving" === a ? "" : "none"), this._trafficTimeWidget.set("disabled", "time" !== b && "driving" !== a),
                this._trafficTimeWidget.set("reset", "time" !== b && "driving" !== a));
            ...
            }]), this.set("breakUnits", this._distanceUnitsSelect.get("value"))) : (this.get("distanceDefaultUnits") && this.set("breakUnits", this.get("distanceDefaultUnits")), this._distanceUnitsSelect.removeOption(this._distanceUnitsSelect.getOptions()),
        ...
        _handleOverlapPolicyChange: function(a, b) {
            ...
            l.remove(this._Overlap, "selected");
            l.remove(this._Dissolve, "selected");
            l.remove(this._Split,
                "selected");
            l.add(a, "selected")
        },
        _save: function() {},
        _buildUI: function() {
            ...
            p.set(this._chooseFolderRow, "display", !0 === this.showSelectFolder ? "block" : "none");
            ...
            p.set(this._chooseExtentDiv, "display", !0 === this.showChooseExtent ? "inline-block" : "none");
        ...
        validateDistance: function() {
            ...
            b =
                c.trim(this._breakValuesInput.get("value")).split(" ");
            ...
            h.forEach(b, function(b) {
                ...
                q.isDefined(g) ? q.isDefined(g) || (g = m.format(b, {
                    locale: "en-us"
                })) : g = m.format(b, {
                    locale: "en"
                });
                q.isDefined(g) && (e = c.trim(g).match(/\D/g));
        ...
        _setOutputLayerNameAttr: function(a) {
            var b,
                d, c;
            d = [this.i18n.seconds, this.i18n.minutes, this.i18n.hours, this.i18n.miles, this.i18n.meters, this.i18n.kilometers, this.i18n.feet, this.i18n.yards];
            c = this._distanceUnitsSelect.getOptions(this._distanceUnitsSelect.get("value")).label;
            a ? (this.outputLayerName = a, this.outputLayerInput.set("value", a)) : this._breakValuesInput && (this.outputLayerName ? (this.outputLayerName = this.outputLayerInput.get("value"), a = this.outputLayerName.substr(0, this.outputLayerName.indexOf(" ")), a !== this.i18n[this.travelMode.toLowerCase()] &&
                    (this.outputLayerName = this.outputLayerName.replace(a, this.i18n[this.travelMode.toLowerCase()])), -1 !== this.outputLayerName.lastIndexOf("(") && (a = this.outputLayerName.substring(0, this.outputLayerName.lastIndexOf("(")), b = f.trim(this.outputLayerName.substring(this.outputLayerName.lastIndexOf(" "), this.outputLayerName.lastIndexOf(")"))), -1 !== h.indexOf(d, b) && (this.outputLayerName = f.substitute(a + "(${breakValues} ${breakUnits})", {
                        breakValues: this._breakValuesInput.get("value"),
                        breakUnits: c
                    })))) : this.outputLayerName =
                f.substitute(this.i18n.outputModeLayerName, {
