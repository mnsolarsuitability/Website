    ...
    return L(Q, {
        ...
        _createSimpleSlider: function() {
            if (this._mapParams.slider) {
                ...
                this._connects.push(e(b, c, this, this._simpleSliderChangeHandler));
                this._connects.push(e(d,
        ...
        _simpleSliderChangeHandler: function(a) {
            B.stop(a);
            a = -1 !== a.currentTarget.className.indexOf("IncrementButton") ?
                !0 : !1;
            this._extentUtil({
                numLevels: a ? 1 : -1
            })
