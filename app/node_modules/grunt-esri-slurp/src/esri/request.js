...
define(["require", "dojo/_base/array", "dojo/_base/config", "dojo/_base/Deferred", "dojo/_base/lang", "dojo/_base/url", "dojo/_base/xhr", "dojo/io/script", "dojo/io/iframe", "dojo/dom-construct", "dojo/io-query", "./kernel", "./config", "./sniff", "./lang", "./urlUtils", "./deferredUtils"], function(P, w, J, R, p, W, z, X, Y, S, T, l, Z, r, x, q, $) {
    ...
    function I(a) {
        ...
        if (m.corsDetection && m.useCors) try {
            var e = K(a);
            r("esri-cors") && (a && -1 !== a.toLowerCase().indexOf("/rest/services") && !q.hasSameOrigin(a, window.location.href) &&
                !q.canUseXhr(a) && !d[e]) && (d[e] = -1, z.get({
    ...
    function n(a, d) {
        ...
        var s = k && k.append,
            y = k && (k.elements ? w.some(k.elements,
                function(a) {
                    return "file" === a.type
                }) : s),
        ...
        if (a._usrDfd) f = a._usrDfd;
            ...
            f.addCallback(function(b) {
                ...
                if (b = a._credential) {
                    ...
                    if (c = c && c.owningSystemUrl) c = c.replace(/\/?$/, "/sharing"), (b = l.id.findCredential(c, b.userId)) && -1 === l.id._getIdenticalSvcIdx(c, b) && b.resources.splice(0, 0, c)
                }
            });
        ...
        if (l.id && !A && !a._token && !l.id._isPublic(a.url) && (!p || t))
            if (k = l.id.findCredential(a.url)) a._token = k.token,
                a._ssl = k.ssl;
