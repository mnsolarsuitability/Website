...
<head>
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>MN Solar Location Report</title>
...
<p><b>Latitude</b>: <?php echo round($_REQUEST['lat'],7); ?> <b> &nbsp;Longitude: </b><?php echo round($_REQUEST['long'],7); ?><br>

<div id="map"></div><div id="smap"></div>
</p>

<p>
<strong>INSOLATION</strong><tt>(kWh/m<sup>2</sup>)<strong>:</strong></tt> <br />
Daily Average: <strong><?php echo round($_REQUEST['y']/365,3); ?></strong> &nbsp; Yearly Total: <strong><?php echo $_REQUEST['y']; ?></strong>
</p>
<p>
<div id="resultsHisto"></div><div id="sunHrHisto"></div>
</p>
