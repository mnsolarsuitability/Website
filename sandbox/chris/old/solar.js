...
$(window).load(function () {
    ...
    Map,
    Tiled, ImageServiceParameters, ArcGISImageServiceLayer, FeatureLayer,
    Draw, Graphic, Point,
    ...
    on, domClass, dojoJson, registry, Query, QueryTask, BasemapToggle, InfoTemplate) {
		...
		var installLayer = new esri.layers.FeatureLayer("http://us-dspatialgis.oit.umn.edu:6080/arcgis/rest/services/solar/solar_fgdb/MapServer/2",{
        ...
        function addGraphic(pt) {
            var graphic = new Graphic(pt, pinSymbol);
