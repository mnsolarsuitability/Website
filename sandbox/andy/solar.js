        ...
        function pixelQuery(e) {
            ...
            BEQueryTask.execute(BEquery, function (results) {
                ...
                if (results.features && results.features.length > 0) {
                    ...
                    var result = "<H3><strong>INSOLATION (kWh/m<sup>2</sup>)</strong></H3><p>Total per Year: Unknown**<br />Avg per Day: Unknown**</p><p>**The point you clicked is outside of the study area.</p>";
