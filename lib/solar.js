                ...
                if (results.features && results.features.length > 0) {
                    ...
                    queryTask.execute(query, function (results) {
                        ...
                        queryTask.execute(query, function (results) {
                            ...
                            var result = "<p><b>Utility Service Provider:   </b><br />" + fullname + "<br />" + street + "<br />" + city + ", MN " + zip + "<br />" + phone + "<br /><a target='_blank' href='http://" + website + "'>" + website + "</a></p><p><a href='http://www.dsireusa.org/solar/incentives/index.cfm?re=1&ee=1&spv=1&st=0&srp=0&state=MN' target='_blank'>MN Incentives/Policies for Solar</a></p>" + getstarted + "<p>Report bad data <a href='http://solar.maps.umn.edu/bad_data_handler.php?coords=" + e.mapPoint.x + "%2C%20" + e.mapPoint.y + "' target='_blank'>here</a>.</p>";
